export default {
  ...
  characters: {
    ...
    bacon: {
      model: require('../assets/models/characters/saul/saulgoodman.obj'),
      texture: require('../assets/models/characters/saul/saulgoodman.png'),
    },*/
    chicken: {
  ...
  alphabet: {
    letters: {
      0: {
        ...
        texture: require('../assets/models/letters/orang.png'),
      },
      1: {
        scale: 0.05,
